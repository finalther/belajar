							...
							<div class="col-md-12">
								<div class="panel">
									...
									<div class="panel-body">
										<a href="<?= base_url()?>laporan/cetak_laporan_keluar" type="submit" name="print" id="print" class="btn btn-primary" style="float:right;" target="blank" >Print</a>
										<div id="b_print">
											<table id="datatable" class="table">
												...
												<tbody>
												<?php $no=1; foreach ($b_keluar as $val) :?>
												<tr>
													<td><?= $no++?></td>
